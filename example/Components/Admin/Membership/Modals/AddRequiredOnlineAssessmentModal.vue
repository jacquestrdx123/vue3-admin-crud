...
const submitForm = async () => {
  ...
  try {
    const routeName = editingAssessment.value
      ? 'vue.memberships.required-online-assessments.update'
      : 'vue.memberships.required-online-assessments.store'
    
    const routeParams = editingAssessment.value
      ? { id: props.membershipId, assessmentId: props.assessment.id }
