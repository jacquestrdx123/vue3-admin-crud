...
const submitForm = async () => {
  ...
  try {
    const routeName = editingAssessment.value
      ? 'vue.designations.required-online-assessments.update'
      : 'vue.designations.required-online-assessments.store'
    
    const routeParams = editingAssessment.value
      ? { id: props.designationId, assessmentId: props.assessment.id }
