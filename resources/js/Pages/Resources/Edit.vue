  ...
  <AdminLayout>
    <div class="py-6">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
          <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">{{ title || 'Edit Resource' }}</h1>
        </div>
...
const submit = () => {
  const routeName = getUpdateRoute()
  if (routeName && route(routeName)) {
    form.put(route(routeName, props.item.id), {
      preserveScroll: true
    })
  }
}
