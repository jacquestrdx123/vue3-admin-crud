<template>
  <DashboardLayout title="Dashboard" description="Welcome to your admin dashboard">
    <!-- Stats Cards -->
...
// Vite will resolve app versions first, then vendor versions
...
// Sample recent activity - replace with your actual data
...
// Sample quick actions - replace with your actual actions
